      ...
      <div className="relative mx-auto max-w-4xl px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative w-11 h-11 mx-auto rounded-xl bg-foreground/5 border border-foreground/10 flex items-center justify-center mb-4"
                >
                ...
                <p className="relative mt-2 text-foreground/50">{stat.label}</p>
              </motion.div>
            );
          })}
          ...
          >
            ...
            <p className="relative mt-2 text-foreground/50">Aucun template, code fait main</p>
          </motion.div>
        </div>
      </div>
    </section>
